...
>
> **Previous version:** 3.7.19 (current structure)
> **New version:** 3.8.1
...
4. Or manually copy files from `archive/upgrades/backup-3.7.19-2026-01-31T21-40-26/`
...
- [x] `.github/episodic/` — 6 session records (meditation, dreams) (30 KB)
...
`archive/upgrades/backup-3.7.19-2026-01-31T21-40-26/`
