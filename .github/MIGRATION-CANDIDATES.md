...
>
> **Previous version:** 3.7.7 (current structure)
> **New version:** 3.7.9
...
4. Or manually copy files from `archive/upgrades/backup-3.7.7-2026-01-31T18-04-19/`
...
- [x] `.github/episodic/` — 17 session records (meditation, dreams) (70 KB)
...
`archive/upgrades/backup-3.7.7-2026-01-31T18-04-19/`
